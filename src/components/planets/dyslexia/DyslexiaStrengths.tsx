...
export function DyslexiaStrengths() {
  ...
  const activeStrength = dyslexiaPlanetMobile.strengthsAndSensitivities.find(
    s => s.id === modalOpen
  );
    ...
    >
      <div className="space-y-6 py-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          {dyslexiaPlanetMobile.strengthsAndSensitivities.map((strength) => (
            <button
              key={strength.id}
          ...
          >
            ...
            <motion.div
              ...
              style={{
                ...
                boxShadow: "inset 0 0 0 1px rgba(255, 107, 157, 0.15)"
              }}
