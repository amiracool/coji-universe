...
export function DyslexiaIntro() {
  ...
  return (
    <PlanetLayout
      currentStep={1}
      totalSteps={6}
      nextRoute="/planets/dyslexia/facts"
    ...
    >
      ...
      <div className="text-center space-y-6 py-12">
        ...
        <p className="text-lg sm:text-xl text-slate-300 max-w-xl mx-auto leading-relaxed" style={{ lineHeight: "1.6" }}>
          Understanding a brain wired for big-picture thinking, creativity, and unique ways of processing language.
        </p>

        {/* Gradient divider */}
        <div
          className="h-1 w-24 mx-auto mt-8 rounded-full opacity-40"
          style={{ background: "linear-gradient(90deg, #FF6B9D, #FF8FAB)" }}
        />
        ...
        <div className="pt-8">
          <button
            ...
            style={{
              background: "linear-gradient(135deg, rgba(255, 107, 157, 0.25) 0%, rgba(255, 143, 171, 0.2) 100%)",
