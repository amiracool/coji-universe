...
export function ParentingHowItShowsUp() {
  ...
  const sections = parentingPlanetMobile.howItShowsUp;

  const handleNext = () => router.push('/planets/parenting/strengths');
  const handlePrev = () => router.push('/planets/parenting/understanding');
  const toggleExpand = (id: string) => setExpandedId(expandedId === id ? null : id);

  return (
    <PlanetLayout currentStep={4} totalSteps={6} nextRoute="/planets/parenting/strengths" prevRoute="/planets/parenting/understanding" onSwipeLeft={handleNext} onSwipeRight={handlePrev} primaryColor="#FFB6A3" accentColor="#FF847C">
