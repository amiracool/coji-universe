...
export function ParentingStrengths() {
  ...
  const handleNext = () => {
    router.push('/planets/parenting/planning');
  };

  const handlePrev = () => {
    router.push('/planets/parenting/how-it-shows-up');
  };
  ...
  const activeStrength = parentingPlanetMobile.strengthsAndSensitivities.find(
    s => s.id === modalOpen
  );
  ...
  return (
    <PlanetLayout
      ...
      primaryColor="#FDCB6E"
      accentColor="#FED78E"
      nextRoute="/planets/parenting/planning"
      prevRoute="/planets/parenting/how-it-shows-up"
      ...
      <div className="space-y-6 py-6">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-slate-100 mb-3">
            Strengths & Sensitivities of Parenting
          </h2>
        ...
        <div className="grid grid-cols-2 gap-4">
          {parentingPlanetMobile.strengthsAndSensitivities.map((strength) => (
            <button
              key={strength.id}
              onClick={() => openModal(strength.id)}
              className="p-4 rounded-xl text-left transition-all duration-200 hover:scale-105"
              style={{
                background: "linear-gradient(135deg, rgba(253, 203, 110, 0.08) 0%, rgba(253, 203, 110, 0.05) 100%)",
          ...
          >
            ...
            <motion.div
              ...
              style={{
                ...
                boxShadow: "inset 0 0 0 1px rgba(253, 203, 110, 0.15)"
              }}
