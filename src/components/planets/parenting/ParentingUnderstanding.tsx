...
export function ParentingUnderstanding() {
  ...
  return (
    <PlanetLayout
      ...
      primaryColor="#FDCB6E"
      accentColor="#FED78E"
      nextRoute="/planets/parenting/how-it-shows-up"
      prevRoute="/planets/parenting/facts"
    ...
    >
      <div className="py-6 flex flex-col min-h-screen" onClick={handlePageClick}>
        ...
        <div className="space-y-6 px-4 pb-12">
          {parentingPlanetMobile.understandingIt.sections.map((section, idx) => {
        ...
        <div className="text-center pt-8 pb-6">
          <p className="text-slate-400 text-sm" style={{ lineHeight: "1.6" }}>
            Next: See how parenting shows up in daily life
          </p>
        </div>
      </div>
