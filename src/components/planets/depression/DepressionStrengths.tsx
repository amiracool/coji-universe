...
export function DepressionStrengths() {
  ...
  const handleNext = () => {
    router.push('/planets/depression/planning');
  };

  const handlePrev = () => {
    router.push('/planets/depression/how-it-shows-up');
  };
  ...
  const activeStrength = depressionPlanetMobile.strengthsAndSensitivities.find(
    s => s.id === modalOpen
  );
  ...
  return (
    <PlanetLayout
      ...
      primaryColor="#7D6B9D"
      accentColor="#9B8BAD"
      nextRoute="/planets/depression/planning"
      prevRoute="/planets/depression/how-it-shows-up"
      ...
      <div className="space-y-6 py-6">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-slate-100 mb-3">
            Strengths & Sensitivities of Depression
          </h2>
        ...
        <div className="grid grid-cols-2 gap-4">
          {depressionPlanetMobile.strengthsAndSensitivities.map((strength) => (
            <button
              key={strength.id}
              onClick={() => openModal(strength.id)}
              className="p-4 rounded-xl text-left transition-all duration-200 hover:scale-105"
              style={{
                background: "linear-gradient(135deg, rgba(125, 107, 157, 0.08) 0%, rgba(125, 107, 157, 0.05) 100%)",
          ...
          >
            ...
            <motion.div
              ...
              style={{
                ...
                padding: "1.5rem",
                maxWidth: "600px",
                border: "1px solid rgba(125, 107, 157, 0.3)",
                boxShadow: "inset 0 0 0 1px rgba(125, 107, 157, 0.15)"
              }}
