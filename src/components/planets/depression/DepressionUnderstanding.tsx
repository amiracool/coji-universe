...
export function DepressionUnderstanding() {
  ...
  return (
    <PlanetLayout
      ...
      primaryColor="#7D6B9D"
      accentColor="#9B8BAD"
      nextRoute="/planets/depression/how-it-shows-up"
      prevRoute="/planets/depression/facts"
    ...
    >
      <div className="py-6 flex flex-col min-h-screen">
        ...
        <div className="space-y-6 px-4 pb-12">
          {depressionPlanetMobile.understandingIt.sections.map((section, idx) => {
        ...
        <div className="text-center pt-8 pb-6">
          <p className="text-slate-400 text-sm" style={{ lineHeight: "1.6" }}>
            Next: See how depression shows up in daily life
          </p>
        </div>
      </div>
