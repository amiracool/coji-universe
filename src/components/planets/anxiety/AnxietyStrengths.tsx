...
export function AnxietyStrengths() {
  ...
  const activeStrength = anxietyPlanetMobile.strengthsAndSensitivities.find(
    s => s.id === modalOpen
  );
    ...
    >
      <div className="space-y-6 py-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          {anxietyPlanetMobile.strengthsAndSensitivities.map((strength) => (
            <button
              key={strength.id}
              onClick={() => openModal(strength.id)}
              className="p-4 rounded-xl text-left transition-all duration-200 hover:scale-105"
              style={{
                background: "linear-gradient(135deg, rgba(155, 134, 232, 0.08) 0%, rgba(155, 134, 232, 0.05) 100%)",
          ...
          >
            ...
            <motion.div
              ...
              style={{
                ...
                padding: "1.5rem",
                maxWidth: "600px",
                border: "1px solid rgba(155, 134, 232, 0.3)",
                boxShadow: "inset 0 0 0 1px rgba(155, 134, 232, 0.15)"
              }}
