...
export function ChronicIllnessUnderstanding() {
  ...
  return (
    <PlanetLayout
      ...
      primaryColor="#6EBD8E"
      accentColor="#8ECDA7"
      nextRoute="/planets/chronic-illness/how-it-shows-up"
      prevRoute="/planets/chronic-illness/facts"
      ...
      <div className="py-6 flex flex-col min-h-screen">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-slate-100 mb-3">
            Understanding ChronicIllness
          </h2>
        </div>

        {/* Visual cards with icons and colors */}
        <div className="space-y-6 px-4 pb-12">
          {chronicillnessPlanetMobile.understandingIt.sections.map((section, idx) => {
        ...
        <div className="text-center pt-8 pb-6">
          <p className="text-slate-400 text-sm" style={{ lineHeight: "1.6" }}>
            Next: See how chronic illness shows up in daily life
          </p>
        </div>
      </div>
