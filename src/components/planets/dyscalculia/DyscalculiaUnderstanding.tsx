...
export function DyscalculiaUnderstanding() {
  ...
  return (
    <PlanetLayout
      ...
      primaryColor="#FFD966"
      accentColor="#F5C542"
      nextRoute="/planets/dyscalculia/how-it-shows-up"
      prevRoute="/planets/dyscalculia/facts"
    ...
    >
      <div className="py-6 flex flex-col min-h-screen">
        ...
        <div className="space-y-6 px-4 pb-12">
          {dyscalculiaPlanetMobile.understandingIt.sections.map((section, idx) => {
        ...
        <div className="text-center pt-8 pb-6">
          <p className="text-slate-400 text-sm" style={{ lineHeight: "1.6" }}>
            Next: See how dyscalculia shows up in daily life
          </p>
        </div>
      </div>
