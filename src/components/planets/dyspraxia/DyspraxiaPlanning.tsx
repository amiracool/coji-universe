...
export function DyspraxiaPlanning() {
  const router = useRouter();
  const [expandedCards, setExpandedCards] = useState<Set<string>>(new Set());

  const categories = dyspraxiaPlanetMobile.planningAhead;
  ...
  return (
    <PlanetLayout
      currentStep={6}
      totalSteps={6}
      prevRoute="/planets/dyspraxia/strengths"
      ...
      <div className="space-y-10 py-8">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-slate-400 text-sm max-w-md mx-auto" style={{ lineHeight: "1.6" }}>
            Practical strategies for navigating life with Dyspraxia
          </p>
          <p className="text-purple-300 text-sm max-w-md mx-auto mt-4" style={{ lineHeight: "1.6", opacity: 0.9 }}>
                ...
                {category.cards.map((card) => {
                  ...
                  return (
                    <div
                      ...
                      style={{
                        background: "linear-gradient(135deg, rgba(197, 138, 255, 0.12) 0%, rgba(140, 82, 255, 0.08) 100%)",
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="text-purple-400 ml-2 mt-1">
                      ...
                      {isExpanded && (
                        <div
                          className="px-4 pb-4"
                          style={{
                            borderTop: "1px solid rgba(197, 138, 255, 0.15)",
        ...
        <div
          ...
          style={{
            background: "linear-gradient(135deg, rgba(140, 82, 255, 0.15) 0%, rgba(197, 138, 255, 0.1) 100%)",
            border: "1px solid rgba(140, 82, 255, 0.3)"
          }}
        >
          <p className="text-slate-200 leading-relaxed" style={{ lineHeight: "1.7" }}>
            Your Dyspraxia brings unique perspectives and creative problem-solving skills. With the right strategies and support, you can thrive.
          </p>
        </div>
      </div>
