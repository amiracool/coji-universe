...
export function DyspraxiaUnderstanding() {
  ...
  return (
    <PlanetLayout
      ...
      primaryColor="#5DADE2"
      accentColor="#7EC8E3"
      nextRoute="/planets/dyspraxia/how-it-shows-up"
      prevRoute="/planets/dyspraxia/facts"
    ...
    >
      <div className="py-6 flex flex-col min-h-screen">
        ...
        <div className="space-y-6 px-4 pb-12">
          {dyspraxiaPlanetMobile.understandingIt.sections.map((section, idx) => {
        ...
        <div className="text-center pt-8 pb-6">
          <p className="text-slate-400 text-sm" style={{ lineHeight: "1.6" }}>
            Next: See how dyspraxia shows up in daily life
          </p>
        </div>
      </div>
