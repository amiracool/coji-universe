...
export function DyspraxiaStrengths() {
  ...
  const activeStrength = dyspraxiaPlanetMobile.strengthsAndSensitivities.find(
    s => s.id === modalOpen
  );
    ...
    >
      <div className="space-y-6 py-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          {dyspraxiaPlanetMobile.strengthsAndSensitivities.map((strength) => (
            <button
              key={strength.id}
              onClick={() => openModal(strength.id)}
              className="p-4 rounded-xl text-left transition-all duration-200 hover:scale-105"
              style={{
                background: "linear-gradient(135deg, rgba(93, 173, 226, 0.08) 0%, rgba(93, 173, 226, 0.05) 100%)",
          ...
          >
            ...
            <motion.div
              ...
              style={{
                ...
                boxShadow: "inset 0 0 0 1px rgba(93, 173, 226, 0.15)"
              }}
