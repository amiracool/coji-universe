...
export function DyspraxiaStrengths() {
  const router = useRouter();
  const [currentIndex, setCurrentIndex] = useState(0);

  const strengths = dyspraxiaPlanetMobile.strengthsAndSensitivities;
  const superpowers = dyspraxiaPlanetMobile.superpowersFacts;
  const [currentSuperpowerIndex, setCurrentSuperpowerIndex] = useState(0);

  const handleNext = () => {
    router.push('/planets/dyspraxia/planning');
  };

  const handlePrev = () => {
    router.push('/planets/dyspraxia/how-it-shows-up');
  };
  ...
  return (
    <PlanetLayout
      currentStep={5}
      totalSteps={6}
      nextRoute="/planets/dyspraxia/planning"
      prevRoute="/planets/dyspraxia/how-it-shows-up"
      ...
      <div className="space-y-10 py-8">
        ...
        <div className="text-center space-y-3">
          <h2 className="text-3xl font-bold text-slate-100 mb-3">
            Strengths & Sensitivities of Dyspraxia
          </h2>
        ...
        <div className="relative max-w-lg mx-auto">
          <div
            ...
            style={{
              background: "linear-gradient(135deg, rgba(197, 138, 255, 0.15) 0%, rgba(140, 82, 255, 0.1) 100%)",
          ...
          <button
            ...
            style={{
              background: "rgba(197, 138, 255, 0.2)",
        ...
        <div className="flex justify-center gap-2">
          {strengths.map((_, index) => (
            <button
              ...
              style={{
                background: index === currentIndex ? "#C58AFF" : "rgba(197, 138, 255, 0.3)",
        ...
        <div className="pt-8">
          ...
          <div className="relative max-w-lg mx-auto">
            <div
              ...
              style={{
                background: "linear-gradient(135deg, rgba(140, 82, 255, 0.2) 0%, rgba(197, 138, 255, 0.15) 100%)",
          ...
          <div className="flex justify-center gap-2 pt-4">
            {superpowers.map((_, index) => (
              <button
                ...
                className="w-2 h-2 rounded-full transition-all duration-200"
                style={{
                  background: index === currentSuperpowerIndex ? "#8C52FF" : "rgba(140, 82, 255, 0.3)",
