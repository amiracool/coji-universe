...
export function IdeasQuestionsPlanning() {
  ...
  const categories = ideasQuestionsPlanetMobile.planningAhead;
      ...
      <div className="space-y-10 py-8">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-slate-400 text-sm max-w-md mx-auto" style={{ lineHeight: "1.6" }}>
            Ways to explore your questions and ideas
          </p>
                ...
                {category.cards.map((card) => {
                  ...
                  return (
                    <div
                      ...
                      style={{
                        background: "linear-gradient(135deg, rgba(167, 139, 250, 0.12) 0%, rgba(196, 181, 253, 0.08) 100%)",
        ...
        >
          <p className="text-slate-200 leading-relaxed" style={{ lineHeight: "1.7" }}>
            Your curiosity, questions, and ideas are valuable. Keep exploring, keep asking, and keep learning.
          </p>
        </div>
      </div>
