...
export function IdeasQuestionsUnderstanding() {
  ...
  return (
    <PlanetLayout
      ...
      primaryColor="#A78BFA"
      accentColor="#C4B5FD"
      nextRoute="/planets/ideas-questions/how-it-shows-up"
      prevRoute="/planets/ideas-questions/facts"
      ...
      <div className="py-6 flex flex-col min-h-screen" onClick={handlePageClick}>
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-slate-100 mb-3">
            Understanding IdeasQuestions
          </h2>
        </div>

        {/* Visual cards with icons and colors */}
        <div className="space-y-6 px-4 pb-12">
          {ideasquestionsPlanetMobile.understandingIt.sections.map((section, idx) => {
        ...
        <div className="text-center pt-8 pb-6">
          <p className="text-slate-400 text-sm" style={{ lineHeight: "1.6" }}>
            Next: See how ideas questions shows up in daily life
          </p>
        </div>
      </div>
