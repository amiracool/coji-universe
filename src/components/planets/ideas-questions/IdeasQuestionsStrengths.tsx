...
export function IdeasQuestionsStrengths() {
  ...
  const activeStrength = ideasquestionsPlanetMobile.strengthsAndSensitivities.find(
    s => s.id === modalOpen
  );
      ...
      <div className="space-y-6 py-6">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-slate-100 mb-3">
            Strengths & Sensitivities of IdeasQuestions
          </h2>
        ...
        <div className="grid grid-cols-2 gap-4">
          {ideasquestionsPlanetMobile.strengthsAndSensitivities.map((strength) => (
            <button
              key={strength.id}
