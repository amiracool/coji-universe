...
export function ADHDStrengths() {
  ...
  const activeStrength = adhdPlanetMobile.strengthsAndSensitivities.find(
    s => s.id === modalOpen
  );
    ...
    >
      <div className="space-y-6 py-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          {adhdPlanetMobile.strengthsAndSensitivities.map((strength) => (
            <button
              key={strength.id}
              onClick={() => openModal(strength.id)}
              className="p-4 rounded-xl text-left transition-all duration-200 hover:scale-105"
              style={{
                background: "linear-gradient(135deg, rgba(249, 110, 70, 0.08) 0%, rgba(255, 170, 92, 0.05) 100%)",
                border: "1px solid rgba(249, 110, 70, 0.2)",
                boxShadow: "0 2px 6px rgba(0, 0, 0, 0.1)",
                minHeight: "44px"
              }}
            >
              <h3 className="text-sm font-semibold mb-2" style={{ color: "#FFAA5C" }}>
                {strength.title}
              </h3>
          ...
          >
            ...
            <motion.div
              ...
              style={{
                ...
                boxShadow: "inset 0 0 0 1px rgba(249, 110, 70, 0.15)"
              }}
            ...
            >
              ...
              <div className="space-y-4 pr-8">
                <h3
                  ...
                  style={{ lineHeight: "1.4", color: "#FFAA5C" }}
                >
