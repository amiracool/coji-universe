...
export function ADHDStrengths() {
  const router = useRouter();
  const [currentIndex, setCurrentIndex] = useState(0);

  const strengths = adhdPlanetMobile.strengthsAndSensitivities;
  const superpowers = adhdPlanetMobile.superpowersFacts;
  const [currentSuperpowerIndex, setCurrentSuperpowerIndex] = useState(0);

  const handleNext = () => {
    router.push('/planets/adhd/planning');
  };

  const handlePrev = () => {
    router.push('/planets/adhd/how-it-shows-up');
  };
  ...
  return (
    <PlanetLayout
      currentStep={5}
      totalSteps={6}
      nextRoute="/planets/adhd/planning"
      prevRoute="/planets/adhd/how-it-shows-up"
      ...
      <div className="space-y-10 py-8">
        ...
        <div className="text-center space-y-3">
          <h2 className="text-3xl font-bold text-slate-100 mb-3">
            Strengths & Sensitivities of ADHD
          </h2>
        ...
        <div className="relative max-w-lg mx-auto">
          <div
            ...
            style={{
              background: "linear-gradient(135deg, rgba(249, 110, 70, 0.15) 0%, rgba(255, 170, 92, 0.1) 100%)",
          ...
          <button
            ...
            style={{
              background: "rgba(249, 110, 70, 0.2)",
              border: "1px solid rgba(249, 110, 70, 0.3)",
              color: "#F96E46",
              minHeight: "44px",
              minWidth: "44px"
            }}
        ...
        <div className="flex justify-center gap-2">
          {strengths.map((_, index) => (
            <button
              ...
              style={{
                background: index === currentIndex ? "#F96E46" : "rgba(249, 110, 70, 0.3)",
        ...
        <div className="pt-8">
          ...
          <div className="relative max-w-lg mx-auto">
            <div
              ...
              style={{
                background: "linear-gradient(135deg, rgba(255, 170, 92, 0.2) 0%, rgba(249, 110, 70, 0.15) 100%)",
                border: "1px solid rgba(255, 170, 92, 0.3)",
          ...
          <div className="flex justify-center gap-2 pt-4">
            {superpowers.map((_, index) => (
              <button
                ...
                className="w-2 h-2 rounded-full transition-all duration-200"
                style={{
                  background: index === currentSuperpowerIndex ? "#FFAA5C" : "rgba(255, 170, 92, 0.3)",
