...
export function ADHDUnderstanding() {
  ...
  return (
    <PlanetLayout
      ...
      primaryColor="#F96E46"
      accentColor="#FFAA5C"
      nextRoute="/planets/adhd/how-it-shows-up"
      prevRoute="/planets/adhd/facts"
    ...
    >
      <div className="py-6 flex flex-col min-h-screen">
        ...
        <div className="space-y-6 px-4 pb-12">
          {adhdPlanetMobile.understandingIt.sections.map((section, idx) => {
        ...
        <div className="text-center pt-8 pb-6">
          <p className="text-slate-400 text-sm" style={{ lineHeight: "1.6" }}>
            Next: See how ADHD shows up in daily life
          </p>
        </div>
      </div>
