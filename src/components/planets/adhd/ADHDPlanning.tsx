...
export function ADHDPlanning() {
  ...
  const categories = adhdPlanetMobile.planningAhead;
      ...
      <div className="space-y-10 py-8">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-slate-400 text-sm max-w-md mx-auto" style={{ lineHeight: "1.6" }}>
            Practical strategies for navigating life with ADHD
          </p>
          <p className="text-orange-300 text-sm max-w-md mx-auto mt-4" style={{ lineHeight: "1.6", opacity: 0.9 }}>
                ...
                {category.cards.map((card) => {
                  ...
                  return (
                    <div
                      ...
                      style={{
                        background: "linear-gradient(135deg, rgba(249, 110, 70, 0.12) 0%, rgba(255, 170, 92, 0.08) 100%)",
                        border: "1px solid rgba(249, 110, 70, 0.25)",
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="text-orange-400 ml-2 mt-1">
                      ...
                      {isExpanded && (
                        <div
                          className="px-4 pb-4"
                          style={{
                            borderTop: "1px solid rgba(249, 110, 70, 0.15)",
        ...
        <div
          ...
          style={{
            background: "linear-gradient(135deg, rgba(255, 170, 92, 0.15) 0%, rgba(249, 110, 70, 0.1) 100%)",
            border: "1px solid rgba(255, 170, 92, 0.3)"
          }}
        >
          <p className="text-slate-200 leading-relaxed" style={{ lineHeight: "1.7" }}>
            Your ADHD brain is wired for creativity, passion, and brilliance. With the right strategies and support, you can thrive.
          </p>
        </div>
      </div>
