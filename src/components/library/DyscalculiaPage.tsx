...
export function DyscalculiaPage({ onBack }: DyscalculiaPageProps = {}) {
  const theme = getPlanetTheme('dyscalculia');
  ...
  return (
    <div className="relative min-h-screen">
      ...
      {/* Content */}
      <div className="max-w-7xl mx-auto px-4 py-6 planet-dyscalculia relative" style={{ zIndex: 10 }}>
        {/* Header section */}
        ...
        <h1 className="text-4xl md:text-5xl font-bold mb-4 text-slate-100">
          Welcome to the Dyscalculia Planet 🔢
        </h1>

        <p className="text-lg md:text-xl text-slate-300 max-w-2xl mx-auto mb-4">
          Number sense, calculation support, math confidence
        </p>

        <p className="text-base text-slate-400 max-w-xl mx-auto italic">
          Math strategies and sensory-kind approaches live here
        </p>
        ...
        <div className="relative mb-6 sm:mb-8 md:mb-12 lg:mb-16 animate-slide-up" style={{ animationDelay: '400ms', zIndex: 10 }}>
          ...
          >
            ...
            <p className="text-slate-300 mb-8 text-lg">
              Explore categories to discover practical tools and alternative approaches
            </p>
            ...
            >
              <div className="space-y-3">
                {dyscalculiaCategories.map((category) => (
