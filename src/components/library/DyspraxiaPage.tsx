...
export function DyspraxiaPage({ onBack }: DyspraxiaPageProps = {}) {
  const theme = getPlanetTheme('dyspraxia');
  ...
  return (
    <div className="relative min-h-screen">
      ...
      {/* Content */}
      <div className="max-w-7xl mx-auto px-4 py-6 planet-dyspraxia relative" style={{ zIndex: 10 }}>
        {/* Header section */}
          ...
          >
            ...
            >
              <div className="space-y-3">
                {dyspraxiaCategories.map((category) => (
