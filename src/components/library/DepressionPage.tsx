...
export function DepressionPage({ onBack }: DepressionPageProps = {}) {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      {/* Content */}
      <div className="max-w-7xl mx-auto px-4 py-6 planet-depression-support relative" style={{ zIndex: 10 }}>
      {/* Header section */}
      <div className="relative text-center mb-8 sm:mb-10 md:mb-12 lg:mb-16 animate-slide-up" style={{ zIndex: 10 }}>
        {/* Planet orb */}
        ...
        >
          ...
          >
            <div className="space-y-3">
              {depressionCategories.map((category) => (
      ...
      <div className="relative mb-1 sm:mb-2 md:mb-4 text-center" style={{ zIndex: 10 }}>
        <div
