...
import { parentingCategories, parentingDidYouKnow } from "@/data/conditions/parenting";
import { getPlanetTheme } from "@/lib/planetThemes";

interface ParentingPageProps {
  onBack?: () => void;
}

export function ParentingPage({ onBack }: ParentingPageProps = {}) {
  const theme = getPlanetTheme('parenting-hub');
  ...
  return (
    <div className="relative min-h-screen">
      ...
      {/* Content */}
      <div className="max-w-7xl mx-auto px-4 py-6 planet-parenting-hub relative" style={{ zIndex: 10 }}>
        {/* Header section */}
        ...
        <h1 className="text-4xl md:text-5xl font-bold mb-4 text-slate-100">
          Welcome to the Parenting Hub Planet 👪
        </h1>
        ...
        <div className="mb-8 sm:mb-10 md:mb-12 lg:mb-16 animate-slide-up" style={{ animationDelay: '200ms', zIndex: 1 }}>
          ...
          <FactCarousel facts={parentingDidYouKnow} colour="var(--planet-primary)" />
        </div>
        ...
        <div className="mb-6 sm:mb-8 md:mb-12 lg:mb-16 animate-slide-up" style={{ animationDelay: '400ms', zIndex: 1 }}>
          ...
          >
            ...
            <p className="text-slate-300 mb-8 text-lg">
              Explore categories to discover practical tools and therapeutic approaches
            </p>
